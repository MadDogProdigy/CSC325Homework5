################################################################
#                       NAMES:          Carmen Nicholson, Eboni Williams
#                       DATE:              November 13, 2017
#                       TITLE:              Williams_Nicholson_HOMEWORK5_PY.py
################################################################

#The function times how long it takes to find all the letters in an alphabetic sequence.
from random import *
...
#-------------------------------------------------------MAIN---------------------------------------------------------
#There are obvious errors in this code.
#So, output generated 3 times.
for i in range(3):
        play(createBoard(), "eboni")
        play(createBoard(), "carmen")
        play(createBoard(), "pradeep")
        play(createBoard(), "chowriappa")
        print()
